...
if Length(EditPassword.text)=0 then showmessage('Поле пароля пустое') else
  begin
    ...
    Query.Locate('Login', Login, [loPartialKey]);
     ...
     Showmessage('Вы создали нового пользователя: '+ Login);
     end
