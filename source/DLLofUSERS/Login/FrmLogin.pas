...
if EditLogin.text='' then showmessage('Поле логина пустое') else
if EditPassword.text='' then showmessage('Поле пароля пустое') else
  begin
