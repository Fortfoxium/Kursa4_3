...
begin
if (Fname_doc.Text='') or (ID_RASP.Text='Не указано') or(name_doc.Text='') or (otchname_doc.Text='') then showmessage('Заполните все поля с *!') else
begin
